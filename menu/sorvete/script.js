...
function changeImage() {
  ...
  images.forEach((image) => {
    if (window.innerWidth <= 677) {
      ...
      image.src =
        "https://gkpb.com.br/wp-content/uploads/2022/10/novo-bobs-candy-dia-das-criancas.jpg"; // Define uma imagem diferente (apenas para exemplo)
    } else {
      image.src =
        "https://polosulsc.com.br/wp-content/webp-express/webp-images/uploads/2018/03/Tr%C3%AAs-tipos-e-sabores-de-sorvete-diferentes-1.jpg.webp"; // Define a imagem original
    }
  });
}
